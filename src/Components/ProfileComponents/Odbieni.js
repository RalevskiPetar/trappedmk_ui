...
const Odbieni = () => {
  return (
    <div className='overflow-y-scroll h-2/12 lg:grid lg:grid-cols-4'>
        <div className=' p-6 overflow-y-scroll flex flex-col border-b-[0.1rem] lg:border-r-[0.1rem]  lg:border-r-slate-200 border-b-slate-200 justify-center items-center'>
