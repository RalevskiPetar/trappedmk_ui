...
const Omileni = () => {
  return (
    ...
    <div className=' p-6 overflow-y-scroll flex flex-col border-b-[0.1rem] border-b-slate-200 border-r-[0.1rem] border-r-slate-200 justify-center items-center'>
       ...
       <AiFillHeart color='violet' size={30}/>
